  ...
  return (
    <section className={styles.newsfeed}>
      ...
      <NewsItem
        ...
        imageSize="Large"
        textBody={`After last night’s final games wrapped up the regular season, the 2026 CMHL Playoffs are set to begin next Friday.\n\nThe 7pm timeslot sees the two newcomers to the league square off as the (1) Seamen battle the (8) Bulldogs. At 8pm, an Original Four clash features the defending champion (2) Axemen taking on the recently rejuvenated (7) Rockies. Immediately after, at 9pm, the (3) Gulls begin their playoff quest to win their second title in three years as they face the (6) Mighty Drunks. Finally, at 10pm, the (4) Toonie Tuesday meet the (5) Jagrbombs in what should be a tightly contested matchup.\n\nWe would like to thank all of the players and supporters of the league as we enter the final three weeks of the season. Good luck to all eight teams in their quest to win the CMHL Cup.`}
      />
      <NewsItem
        title="CMHL Returns"
